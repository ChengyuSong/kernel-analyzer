...
namespace gracfl 
{
    ...
    public:
         ...
         */
        SolverFWTopoParallel(std::string graphfilepath, const Grammar& grammar, uint numOfThreads);
        SolverFWTopoParallel(const std::vector<Edge>& edges, const Grammar& grammar, uint numOfThreads);
